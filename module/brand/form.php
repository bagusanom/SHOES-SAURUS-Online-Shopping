<h2 style="border-bottom: 1px solid; width: 30%; margin-left: 35%;">EDIT/ADD BRAND</h2>
<br>
<?php 
...
if($barang_id)
	{
		...
		$keterangan_gambar = "(Klik chose file untuk mengganti foto)";
...
<form action="<?php echo BASE_URL."module/brand/action.php?barang_id=$barang_id"; ?>" method="POST" enctype="multipart/form-data">
